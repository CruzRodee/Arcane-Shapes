...
namespace DIALOGUE.LogicalLines
{
    public class LL_Choice : ILogicalLine
    {
        ...
        {
            var currentConversation = VNDialogueSystem.instance.conversationManager.conversation;
            var progress = VNDialogueSystem.instance.conversationManager.conversationProgress;
            ...
            VNDialogueSystem.instance.conversationManager.conversation.SetProgress(data.endingIndex);
