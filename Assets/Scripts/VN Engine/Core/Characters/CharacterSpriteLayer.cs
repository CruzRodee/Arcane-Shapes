    ...
    public class CharacterSpriteLayer
    {
        ...
        public void SetSprite(Sprite sprite)
        {
            if (renderer != null)
                ...
                Debug.LogWarning($"CharacterSpriteLayer on layer {layer} is missing its Image renderer. Cannot set sprite.");
        }
        ...
        public Coroutine TransitionSprite(Sprite sprite, float speed = 1)
        {
            ...
            {
                Debug.LogWarning($"CharacterSpriteLayer on layer {layer} is already using the specified sprite. No transition will occur.");
                return null;
            }
        ...
        private IEnumerator ChangingColor(Color color, float speedMultiplier)
        {
            ...
            {
                Image img = oldCG.GetComponent<Image>();
                if (img != null)
                    oldImages.Add(img);
            }
