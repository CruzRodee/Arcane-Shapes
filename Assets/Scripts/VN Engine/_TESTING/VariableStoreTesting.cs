...
namespace TESTING
{
    public class VariableStoreTesting : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            VariableStore.CreateVariable("DB3.float1", 1.23f);
        ...
        private void Update()
        {
            ...
            if (Input.GetKeyDown(KeyCode.X))
            {
                ...
                VariableStore.TrySetValue("DB_Links.L_flt", (float)linked_float + 5f);
            }
            ...
            if (Input.GetKeyDown(KeyCode.V))
            {
                ...
                VariableStore.TrySetValue("DB_Links.L_str", (string)linked_string + " appended");
            }
